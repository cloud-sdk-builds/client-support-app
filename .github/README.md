...
[`@aws-sdk/client-support-app`](https://www.npmjs.com/package/@aws-sdk/client-support-app/v/3.1048.0).
...
- @aws-sdk/client-support-app - [https://cloud-sdk-builds.github.io/?sdk=client-support-app](https://cloud-sdk-builds.github.io/?sdk=client-support-app)
- @aws-sdk/client-support-app v3.1048.0 - [https://cloud-sdk-builds.github.io/?sdk=client-support-app&version=3.1048.0](https://cloud-sdk-builds.github.io/?sdk=client-support-app&version=3.1048.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support-app@3.1048.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JdFLps2tzkAC9CbuYdua3H1dtPUbQgiNmohhXdXOis2R5SWEdYQhw+j1vMfZLbBL
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support-app/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-support-app": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support-app@3.1048.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support-app@3.1048.0/index.min.mjs": "sha384-JdFLps2tzkAC9CbuYdua3H1dtPUbQgiNmohhXdXOis2R5SWEdYQhw+j1vMfZLbBL"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-support-app";
...
```
https://github.com/cloud-sdk-builds/client-support-app/blob/refs/tags/3.1048.0/LICENSE
```
